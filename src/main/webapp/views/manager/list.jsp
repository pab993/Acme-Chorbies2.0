...
<display:table name="chorbies" id="row" requestURI="${requestURI}"
	...
	<jstl:choose>
		...
		<a href="like/chorbi/delete.do?chorbiId=${row.id }"> <spring:message code="chorbi.dislike"/> </a>
		
		</jstl:when>
		
		<jstl:otherwise>
		
		<a href="like/chorbi/create.do?chorbiId=${row.id }"> <spring:message code="chorbi.like"/> </a>
